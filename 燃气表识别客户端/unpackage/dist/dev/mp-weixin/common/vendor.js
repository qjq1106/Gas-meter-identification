...
const pages = [
  {
    ...
    style: {
      navigationBarTitleText: "燃气表识别"
    }
  },
  {
    path: "pages/report/report",
    style: {
      navigationBarTitleText: "识别报告"
    }
  },
  {
...
const b = true, E = "mp-weixin", A = T(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), P = E, C = T('{"address":["127.0.0.1","192.168.1.10"],"servePort":7000,"debugPort":9000,"initialLaunchType":"remote","skipFiles":["<node_internals>/**","E:/微信开发者工具/HBuilderX/plugins/unicloud/**/*.js"]}'), O = T('[{"provider":"aliyun","spaceName":"qjqtest","spaceId":"mp-a3c94801-8b2d-42ab-9436-3059277752d6","clientSecret":"CAXe/ohhcpdZIs1lG72C/Q==","endpoint":"https://api.next.bspapp.com"}]') || [];
let N = "";
try {
  N = "__UNI__A2B9F23";
} catch (e2) {
