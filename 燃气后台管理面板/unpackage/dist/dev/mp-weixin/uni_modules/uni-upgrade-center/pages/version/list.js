...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    n: common_vendor.w(({
      ...
      return {
        a: "57e36a26-4-" + i0 + "," + ("57e36a26-3-" + i0),
        b: "57e36a26-5-" + i0 + "," + ("57e36a26-3-" + i0),
        c: "57e36a26-6-" + i0 + "," + ("57e36a26-3-" + i0),
        d: "57e36a26-7-" + i0 + "," + ("57e36a26-3-" + i0),
        e: "57e36a26-8-" + i0 + "," + ("57e36a26-3-" + i0),
        f: "57e36a26-9-" + i0 + "," + ("57e36a26-3-" + i0),
        g: "57e36a26-10-" + i0 + "," + ("57e36a26-3-" + i0),
        h: "57e36a26-11-" + i0 + "," + ("57e36a26-3-" + i0),
        i: "57e36a26-12-" + i0 + "," + ("57e36a26-3-" + i0),
        j: "57e36a26-3-" + i0 + "," + ("57e36a26-2-" + i0),
        k: common_vendor.f(data, (item, index, i1) => {
          return {
            a: common_vendor.t(item.appid),
            b: "57e36a26-14-" + i0 + "-" + i1 + "," + ("57e36a26-13-" + i0 + "-" + i1),
            c: common_vendor.t(item.title || "-"),
            d: "57e36a26-15-" + i0 + "-" + i1 + "," + ("57e36a26-13-" + i0 + "-" + i1),
            ...
            i: "57e36a26-16-" + i0 + "-" + i1 + "," + ("57e36a26-13-" + i0 + "-" + i1),
            j: "57e36a26-18-" + i0 + "-" + i1 + "," + ("57e36a26-17-" + i0 + "-" + i1),
            k: common_vendor.p({
            ...
            l: "57e36a26-17-" + i0 + "-" + i1 + "," + ("57e36a26-13-" + i0 + "-" + i1),
            m: common_vendor.t($options.store_list_key(item.store_list)),
            n: "57e36a26-19-" + i0 + "-" + i1 + "," + ("57e36a26-13-" + i0 + "-" + i1),
            o: common_vendor.t(item.version),
            p: "57e36a26-20-" + i0 + "-" + i1 + "," + ("57e36a26-13-" + i0 + "-" + i1),
            q: common_vendor.t(item.stable_publish == true ? "已上线" : "已下线"),
            r: "57e36a26-21-" + i0 + "-" + i1 + "," + ("57e36a26-13-" + i0 + "-" + i1),
            s: "57e36a26-23-" + i0 + "-" + i1 + "," + ("57e36a26-22-" + i0 + "-" + i1),
            t: common_vendor.p({
              format: "yyyy-MM-dd hh:mm:ss",
              date: item.create_date,
              threshold: [0, 0]
            }),
            v: "57e36a26-22-" + i0 + "-" + i1 + "," + ("57e36a26-13-" + i0 + "-" + i1),
            w: common_vendor.o(($event) => $options.navigateTo("./detail?id=" + item._id, false), index),
            x: "57e36a26-24-" + i0 + "-" + i1 + "," + ("57e36a26-13-" + i0 + "-" + i1),
            y: index,
            z: "57e36a26-13-" + i0 + "-" + i1 + "," + ("57e36a26-2-" + i0),
            A: common_vendor.p({
              disabled: item.stable_publish
            })
          };
        }),
        l: "57e36a26-2-" + i0 + ",57e36a26-1",
        m: common_vendor.p({
          loading,
    ...
    J: common_vendor.sr("udb", "57e36a26-1"),
    K: common_vendor.p({
