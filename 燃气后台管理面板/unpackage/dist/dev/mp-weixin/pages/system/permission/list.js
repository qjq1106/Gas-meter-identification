...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    l: common_vendor.w(({
      ...
      return {
        a: "51038b70-4-" + i0 + "," + ("51038b70-3-" + i0),
        b: "51038b70-5-" + i0 + "," + ("51038b70-3-" + i0),
        c: "51038b70-6-" + i0 + "," + ("51038b70-3-" + i0),
        d: "51038b70-7-" + i0 + "," + ("51038b70-3-" + i0),
        e: "51038b70-8-" + i0 + "," + ("51038b70-3-" + i0),
        f: "51038b70-3-" + i0 + "," + ("51038b70-2-" + i0),
        g: common_vendor.f(data, (item, index, i1) => {
          return {
            a: common_vendor.t(item.permission_id),
            b: "51038b70-10-" + i0 + "-" + i1 + "," + ("51038b70-9-" + i0 + "-" + i1),
            c: common_vendor.t(item.permission_name),
            d: "51038b70-11-" + i0 + "-" + i1 + "," + ("51038b70-9-" + i0 + "-" + i1),
            e: common_vendor.t(item.comment),
            f: "51038b70-12-" + i0 + "-" + i1 + "," + ("51038b70-9-" + i0 + "-" + i1),
            g: "51038b70-14-" + i0 + "-" + i1 + "," + ("51038b70-13-" + i0 + "-" + i1),
            h: common_vendor.p({
              threshold: [0, 0],
              date: item.create_date
            }),
            i: "51038b70-13-" + i0 + "-" + i1 + "," + ("51038b70-9-" + i0 + "-" + i1),
            ...
            l: "51038b70-15-" + i0 + "-" + i1 + "," + ("51038b70-9-" + i0 + "-" + i1),
            m: index,
            n: "51038b70-9-" + i0 + "-" + i1 + "," + ("51038b70-2-" + i0)
          };
        }),
        h: common_vendor.sr("table", "51038b70-2-" + i0 + ",51038b70-1"),
        i: "51038b70-2-" + i0 + ",51038b70-1",
        j: common_vendor.p({
          loading,
    ...
    K: common_vendor.sr("udb", "51038b70-1"),
