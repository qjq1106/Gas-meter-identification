...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    l: common_vendor.w(({
      ...
      return {
        a: "1a1a5dfe-4-" + i0 + "," + ("1a1a5dfe-3-" + i0),
        b: "1a1a5dfe-5-" + i0 + "," + ("1a1a5dfe-3-" + i0),
        c: "1a1a5dfe-6-" + i0 + "," + ("1a1a5dfe-3-" + i0),
        d: "1a1a5dfe-7-" + i0 + "," + ("1a1a5dfe-3-" + i0),
        e: "1a1a5dfe-8-" + i0 + "," + ("1a1a5dfe-3-" + i0),
        f: "1a1a5dfe-9-" + i0 + "," + ("1a1a5dfe-3-" + i0),
        g: "1a1a5dfe-3-" + i0 + "," + ("1a1a5dfe-2-" + i0),
        h: common_vendor.f(data, (item, index, i1) => {
          return {
            a: common_vendor.t(item.role_id),
            b: "1a1a5dfe-11-" + i0 + "-" + i1 + "," + ("1a1a5dfe-10-" + i0 + "-" + i1),
            c: common_vendor.t(item.role_name),
            d: "1a1a5dfe-12-" + i0 + "-" + i1 + "," + ("1a1a5dfe-10-" + i0 + "-" + i1),
            e: common_vendor.t(item.permission),
            f: "1a1a5dfe-13-" + i0 + "-" + i1 + "," + ("1a1a5dfe-10-" + i0 + "-" + i1),
            g: common_vendor.t(item.comment),
            h: "1a1a5dfe-14-" + i0 + "-" + i1 + "," + ("1a1a5dfe-10-" + i0 + "-" + i1),
            i: "1a1a5dfe-16-" + i0 + "-" + i1 + "," + ("1a1a5dfe-15-" + i0 + "-" + i1),
            j: common_vendor.p({
              threshold: [0, 0],
              date: item.create_date
            }),
            k: "1a1a5dfe-15-" + i0 + "-" + i1 + "," + ("1a1a5dfe-10-" + i0 + "-" + i1),
            ...
            n: "1a1a5dfe-17-" + i0 + "-" + i1 + "," + ("1a1a5dfe-10-" + i0 + "-" + i1),
            o: index,
            p: "1a1a5dfe-10-" + i0 + "-" + i1 + "," + ("1a1a5dfe-2-" + i0)
          };
        }),
        i: common_vendor.sr("table", "1a1a5dfe-2-" + i0 + ",1a1a5dfe-1"),
        j: "1a1a5dfe-2-" + i0 + ",1a1a5dfe-1",
        k: common_vendor.p({
          loading,
    ...
    M: common_vendor.sr("udb", "1a1a5dfe-1"),
