  ...
  methods: {
    ...
    autoFill() {
      ...
      this.requestCloudFunction("getAppInfo", {
        ...
        common_vendor.index.__f__("error", "at pages/system/app/mixin/publish_add_detail_mixin.js:190", e);
      }).finally(() => {
    ...
    fetchAppInfo(appid, platform) {
      ...
      return this.requestCloudFunction("getAppVersionInfo", {
        ...
        common_vendor.index.__f__("error", "at pages/system/app/mixin/publish_add_detail_mixin.js:224", e);
      }).finally(() => {
        common_vendor.index.hideLoading();
      });
    },
...
exports.mixin = mixin;
//# sourceMappingURL=../../../../../.sourcemap/mp-weixin/pages/system/app/mixin/publish_add_detail_mixin.js.map
