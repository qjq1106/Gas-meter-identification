  ...
  methods: {
    async submit() {
      try {
        ...
        common_vendor.index.$u.toast("添加失败");
        common_vendor.index.__f__("error", "at pages/report/add.vue:179", err);
      }
    },
    cancel() {
      common_vendor.index.navigateBack();
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    I: common_vendor.sr("form", "683b64e0-0"),
    J: common_vendor.p({
      model: $data.formData,
      rules: $data.rules,
...
//# sourceMappingURL=../../../.sourcemap/mp-weixin/pages/report/add.js.map
